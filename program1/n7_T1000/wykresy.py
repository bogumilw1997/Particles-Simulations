...
sns.lineplot(x='t', y='H', data=df, ax=axs[0]).set(ylabel='H [kJ/mol]', title = "Wykresy dla n = 7 i T = 1000K", xticks = np.arange(0,df['t'].iloc[-1]), xlabel = '', yticks = np.arange(min ,max,step), ylim = (min ,max))
