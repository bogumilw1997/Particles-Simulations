...
sns.lineplot(x='t', y='H', data=df, ax=axs[0]).set(ylabel='H [kJ/mol]', title = "Wykresy dla n = 5 i T = 1000K", xticks = np.arange(0,df['t'].iloc[-1]), xlabel = '', yticks = np.arange(919.9,920.1,0.05), ylim = (919.9,920.1))
